...
#OPENDATA_CONEXION_BD="jdbc:oracle:thin:@pro01-scan.aragon.local:47017/MDEPJ2EE_GN4_02.ARAGON.LOCAL"
OPENDATA_CONEXION_BD="(DESCRIPTION=(LOAD_BALANCE=on)(ADDRESS=(PROTOCOL=TCP)(HOST=pro01-scan.aragon.local)(PORT=47017))(CONNECT_DATA=(SERVICE_NAME=MDEPJ2EE_GN4_02.ARAGON.LOCAL)))"
