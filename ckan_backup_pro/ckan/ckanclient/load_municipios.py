...
def main():
    ...
    for municipio in listado_municipios:
        ...
        rdftotal = rdftotal  + "		<dct:organization>direccion-general-administracion-electronica-sociedad-informacion</dct:organization>\n"
