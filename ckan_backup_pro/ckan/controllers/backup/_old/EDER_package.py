...
#Esta funcion recibe un str y si tiene url (http://) lo metemos como si fuese enlaces en html. Con href
def url2HREF(str):
    dev=""
    if str.find('http://') != -1:
        iniURL = 0
...
#        q = c.q = request.params.get('q', u'')
    ...
    def read(self, id, format='html'):
        ...
        try:
            ...
            #Recorremos todos los extras para que modifique los value que tiene una uri dentro de ella  para que les a̱ada el href
    ...
    def new_resource(self, id, data=None, errors=None, error_summary=None):
        ...
        if request.method == 'POST' and not data:
            ...
            # consider file.upload as simple file
   #         if (data['resource_type'] == 'file.upload'):
    #          data['resource_type'] = 'file'
            ...
            if save_action == 'go-metadata':
                ...
                redirect(h.url_for(controller='package',
                                   action='read', id=id))
            #elif save_action == 'check-resource':
            #    return 'OK'
            else:
                # add more resources
                redirect(h.url_for(controller='package',
...
#                     return redirect(resource['url'])
    ...
    def showVista(self):
        ...
        if params:
            ...
            #Ckan revisando los recursos que tiene, en los recursos showVista no tiene a̱adido ni el name ni el formato entonces da el error del mail
            if params.get('name'):
	    ...
	    #sentencia = 'SELECT * FROM ' + datosVista[0][0] + " where  rownum <= 3";

            sentencia = 'SELECT * FROM ' + datosVista[0][0];
	    #sentencia3 = 'SELECT * FROM ' + datosVista[0][0];
	    sentencia3 = 'SELECT aproximated_time FROM ' + datosVista[0][0]+ " limit 1" ;
		...
		print '.....vistasPSQL..package'
			...
			sentencia3 = sentencia3 + " WHERE " + str(filtro)+ " limit 1" ;
			print "sentencia33..." + sentencia3
