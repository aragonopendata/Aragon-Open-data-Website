...
class StorageAPIController(BaseController):
	...
	#import urllib2
        #data = urllib2.urlopen("http://opendata.aragon.es/GA_OD_Core/preview?view_id="+str(vista_id)+"&select_sql=*&filter_sql=").read()        
	return data
...
"""
	...
	cursor = connection.cursor()
	    ...
	    sentencia5='select * FROM open_poligonos';
            ...
            if (datosVista[0][1] =='APP1' or datosVista[0][1] =='APP2' or datosVista[0][1] =='APP6'):
            	
		##vistasNormales
	    	print "...APP1/APP2/APP6...storage"
