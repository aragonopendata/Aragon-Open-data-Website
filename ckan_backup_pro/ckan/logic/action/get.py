...
def group_list_authz(context, data_dict):
    ...
    #hacked for showing every groups to everybody
    sysadmin = True
...
def package_show(context, data_dict):
    ...
    #recupero los extras de IAEST
    guardarExtras = package_dict["extrasIAEST"]

    if schema and context.get('validate', True):
        package_dict, errors = _validate(package_dict, schema, context=context)

    package_dict["extrasIAEST"] = guardarExtras
...
#    log.error('En el package search se busca '+str(data_dict)+' y del tipo '+str(type(data_dict)))
...
def organization_activity_list_html(context, data_dict):
    ...
    return activity_streams.activity_list_to_html(context, activity_stream, extra_vars)
