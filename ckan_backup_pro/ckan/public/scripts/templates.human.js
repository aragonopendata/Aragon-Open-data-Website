...
CKAN.Templates.resourceDetails = ' \
  <div style="display: none;" class="resource-details"> \
    ...
    <div class="control-group {{if resource.url_error}} error{{/if}}"> \
      ...
      <div class="controls"> \
        {{if resource.resource_type=="file.upload" || resource.resource_type=="vista"}} \
          ${resource.url} \
    ...
    <div class="control-group"> \
      ...
      <div class="controls"> \
	 {{if resource.resource_type=="vista"}} \
          ${resource.format} \
          <input name="resources__${num}__format" type="hidden" value="${resource.format}" /> \
        {{/if}} \
	{{if resource.resource_type!="vista"}} \
