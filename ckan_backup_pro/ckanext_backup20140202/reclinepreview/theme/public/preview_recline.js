...
this.ckan.module('reclinepreview', function (jQuery, _) {
  return {
    options: {
      i18n: {
        errorLoadingPreview: "Error cargando la previsualizaci&oacute;n",
        errorDataProxy: "Error accediendo a los datos",
        errorDataStore: "Error accediendo a los datos",
        previewNotAvailableForDataType: "Previsualizaci&oacute;n no disponible para este formato: "
      },
      site_url: ""
    },
    ...
    loadPreviewDialog: function (resourceData) {
      ...
      recline.Backend.DataProxy.timeout = 20000;
